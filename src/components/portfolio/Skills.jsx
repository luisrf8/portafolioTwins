...
const Skills = ({ data }) => {
  ...
  const skills = Array.isArray(portfolioData?.skils) ? portfolioData.skils : [];
  ...
  return (
    <Section id="skills">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        {skills.length === 0 && (
          <p className="col-span-full text-center text-muted-foreground">No hay skills disponibles todavía.</p>
        )}
      </div>
    </Section>
  );
